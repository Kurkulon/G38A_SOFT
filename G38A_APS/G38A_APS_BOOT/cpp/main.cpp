...
#define BOOT_COM_POSTTIMEOUT		(US2COM(390))
#define BOOT_HANDSHAKE_PRETIMEOUT	(MS2COM(100))
#define BOOT_HANDSHAKE_POSTTIMEOUT	(US2COM(390))
#define BOOT_SGUID					0x4579F2EA8D9D4818
#define BOOT_MGUID					0x8E581679790D2B1C
